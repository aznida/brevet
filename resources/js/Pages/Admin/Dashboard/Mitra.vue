                            ...
                            <table class="table table-bordered table-centered table-nowrap mb-0 rounded">
                                ...
                                <tbody>
                                    <tr v-for="(stat, index) in filteredAreaStats" :key="index">
                                        ...
                                        <td>{{ stat.title }}</td>
                                        <td class="text-center">{{ stat.starter }}</td>
                                        <td class="text-center">{{ stat.basic }}</td>
                                        <td class="text-center">{{ stat.intermediate }}</td>
                                        <td class="text-center">{{ stat.advanced }}</td>
                                        <td class="text-center">{{ stat.expert }}</td>
                                    </tr>
                                    <tr class="bg-light fw-bold">
                                        <td colspan="2" class="text-center">Total</td>
                                        <td class="text-center">{{ getTotalByLevel('starter') }}</td>
                                        <td class="text-center">{{ getTotalByLevel('basic') }}</td>
                                        <td class="text-center">{{ getTotalByLevel('intermediate') }}</td>
                                        <td class="text-center">{{ getTotalByLevel('advanced') }}</td>
                                        <td class="text-center">{{ getTotalByLevel('expert') }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
